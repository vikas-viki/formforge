...
export default function Landing() {
    return (
        <section id="home" className={`text-white h-max xl:h-[100vh] w-[100vw] overflow-hidden relative`}>
            ...
            <Navbar />
            <div className="flex flex-col gap-[20px] jsutify-center items-center pt-20 relative p-4 z-10">
                ...
                <button className="self-right w-max text-nowrap px-8 py-3 rounded-[5px] bg-[#1C2D5C] text-[12px] md:text-[16px] cursor-pointer mt-4">Take Me In</button>
            </div>
